...
<ul class="nav nav-pills">
  ...
  <li role="presentation"><a href="http://localhost:1080/dhcp/index.php">DHCP and DNS</a></li>
  <li role="presentation"><a href="http://localhost:1080/dhcp/config_subnet.php">Subnet</a></li>
  <li role="presentation"><a href="http://localhost:1080/dhcp/config_zone_detail.php">Zone Detail</a></li>
</ul>
-->
<nav class="navbar navbar navbar-inverse">
<div class="container">
<p class="navbar-text navbar-left"><font size="3">MENU</font></p>
<p class="navbar-text navbar-left"><a href="http://localhost:1080/dhcp/index1.php" class="navbar-link"><font size="3">DHCP and DNS</font></a></p>
